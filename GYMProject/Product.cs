...
namespace GYMProject
{
    public partial class Product : Form
    {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    foreach (DataRow row in dataTable.Rows)
                    {
                        ...
                        // Ürün ismine göre Label'lara veri atama
                        ...
                        // Diğer ürünler için de aynı şekilde devam edebilirsiniz
                    }
                }
            }
            catch (Exception ex)
        ...
        private void refrestDbButton_Click(object sender, EventArgs e)
        {
            Product_Load(sender, e);
            MessageBox.Show("Database Refreshed");
        }

        private void workoutGlovesPrice_Click(object sender, EventArgs e)
        {
